...
== Example of use
  ...
  User # is it an ActiveRecord, DM Resource, CouchDB, MongoMapper or MongoId Document?
...
Currently supported ORMs are *ActiveRecord*, *DataMapper*, *Couchrest_Model*, *MongoMapper*, and *MongoId*. The work for couchDB has been included from {shenoudab's orm_adapter fork}[http://github.com/shenoudab/orm_adapter]
