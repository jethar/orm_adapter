...
Gem::Specification.new do |s|
  ...
  s.authors = ["Harjeet Singh", "Ian White", "Jose Valim"]
  ...
  s.email = "harjeetss@gmail.com"
  s.homepage = "http://github.com/jethar/orm_adapter"
  ...
  s.add_development_dependency "couchrest_model", ">= 1.1.0"
